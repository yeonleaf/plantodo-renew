...
public class GlobalControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ResponseEntity<?> methodArgumentTypeMismatchExceptionHandler(Exception ex) throws JsonProcessingException {
        ApiSimpleError apiSimpleError = new ApiSimpleError("Input type mismatch", ex.getMessage());
        String responseData = objectMapper.writeValueAsString(apiSimpleError);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseData);
    }
