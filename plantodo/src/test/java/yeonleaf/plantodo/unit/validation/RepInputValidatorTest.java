...
public class RepInputValidatorTest {
    ...
    private void assertValidation(Long repOption, int reverse, String... target) {
    ...
    void validateInputTestAbnormalRepValueSize() {
        assertValidation(1L, 0, "월");
        assertValidation(2L, 0);
        assertValidation(2L, 0, "-2", "3");
        assertValidation(3L, 0);
        assertValidation(3L, 0, "월", "화", "수", "목", "금", "토", "월", "일");
    }
    ...
    void validateInputTestAbnormalRep2NeedsNumber() {
        ...
        assertValidation(2L, 0, "한2");
        assertValidation(2L, 0, "%5");
        assertValidation(2L, 0, "3.05");
        assertValidation(2L, 0, "3L");
        assertValidation(2L, 0, "3e6F");
        assertValidation(2L, 0, "3e6");
        assertValidation(2L, 0, "-3");
        assertValidation(2L, 0, "0");
        assertValidation(2L, 1, "+3");
